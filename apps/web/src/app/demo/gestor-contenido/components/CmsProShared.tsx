...
/* ============================================================================
 * Constantes compartidas — sites y workflow steps reusables en topbar/drawers.
 * ============================================================================ */
...
/* ============================================================================
 * TabTitle — encabezado compartido para secciones internas.
 * ============================================================================ */
...
/* ============================================================================
 * CmsDrawer — drawer lateral reutilizable con backdrop y cierre por Escape.
 * ============================================================================ */
...
/* ============================================================================
 * AI panel — prompt + streaming mock + brand/SEO/tone chips.
...
/* ============================================================================
 * Workflow panel — stepper + approvals + cambiar estado.
 * Feature: Workflow editorial.
 * ============================================================================ */
  ...
  return (
    <div>
      ...
      <div className="mb-2 text-sm text-slate-600 dark:text-slate-400">
        {t('currentDoc')}:{' '}
        <span className="font-semibold text-slate-900 dark:text-white">Press release · Q2 launch</span>
      </div>
      ...
      <div>
        ...
        <div className="mt-4 text-xs text-slate-500 dark:text-slate-400">
          {t('scheduledFor')}: 2026-05-20 09:00 UTC
        </div>
      </div>
    </div>
  );
...
/* ============================================================================
 * Multisite panel — métricas por sitio.
...
/* ============================================================================
 * I18n panel — tabla de traducciones por idioma.
            ...
            {I18N_ROWS.map((r, i) => (
              <tr key={i} className="bg-white dark:bg-slate-900">
                ...
                <td className="px-4 py-2">
                  <span
                    className={`px-2 py-0.5 rounded-full text-xs font-semibold border ${I18N_STATUS_COLORS[r.status]}`}
                  >
                    {t(`status.${r.status}`)}
                  </span>
                </td>
...
/* ============================================================================
 * SEO panel — cards Schema/Sitemap/hreflang/OG + SERP preview.
  ...
  return (
    <div>
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4">
        ...
        <div className="text-blue-700 dark:text-blue-400 text-base font-medium leading-snug">
          {t('serpTitle')}
        </div>
...
/* ============================================================================
 * A/B testing panel — tabla con significancia.
...
/* ============================================================================
 * Edge personalization panel — matriz segmentos × contenido.
 * Feature: Edge personalization.
 * ============================================================================ */
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300">
            <tr>
              ...
              {EDGE_CONTENTS.map((c) => (
                <th key={c} className="text-left px-4 py-2 font-semibold">
                  {t(`contents.${c}`)}
                </th>
              ))}
            </tr>
...
/* ============================================================================
 * Blocks panel — editor estilo Notion.
      ...
      <div className="space-y-2">
        {blocks.map((b) => {
          ...
          return (
            ...
            >
              <div
                className="cursor-grab text-slate-400 group-hover:text-pink-500 mt-1"
...
/* ============================================================================
 * DAM panel — grid de assets con AI tags y face detection.
        ...
        {DAM_ASSETS.map((id) => (
          ...
          >
            <div className="aspect-video bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 dark:from-pink-900/40 dark:via-purple-900/40 dark:to-blue-900/40 flex items-center justify-center relative">
              ...
              {faceDetection && id === 'a6' && (
                <div
                  className="absolute top-3 left-3 w-12 h-12 border-2 border-pink-500 rounded"
                  aria-label="face-box"
                />
              )}
            </div>
...
/* ============================================================================
 * Headless panel — diagrama CMS→API→Edge y métricas.
 * Feature: Headless architecture.
 * ============================================================================ */
      ...
      <div className="flex flex-col md:flex-row items-stretch gap-3 mb-6">
        {nodes.map((n, i) => (
          <div key={n.label} className="flex-1 flex items-center gap-3">
            <div
              className={`flex-1 px-4 py-5 rounded-xl text-white text-center font-semibold bg-gradient-to-br ${n.color} shadow`}
            >
              {n.label}
            </div>
            {i < nodes.length - 1 && (
              <div className="text-slate-400 hidden md:block text-2xl font-bold">→</div>
            )}
          </div>
        ))}
      </div>
...
/* ============================================================================
 * ISR panel — timeline cache + revalidación.
 * Feature: ISR.
 * ============================================================================ */
